...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_lista_de_elementos = 24,        /* lista_de_elementos  */
  YYSYMBOL_elemento = 25,                  /* elemento  */
  YYSYMBOL_declaracao_global = 26,         /* declaracao_global  */
  YYSYMBOL_definicao_de_funcao = 27        /* definicao_de_funcao  */
};
...
static const char *const yytname[] =
{
  ...
  "programa", "lista_de_elementos", "elemento", "declaracao_global",
  "definicao_de_funcao", YY_NULLPTR
};
