...
static const yytype_int16 yyrline[] =
{
     ...
     430,   435,   440,   445,   451,   455,   459,   466,   470,   476,
     481,   486,   493,   497,   501,   507
};
#endif
...
#line 158 "parser.y"
{
    (yyval.node) = create_node_valor_lexico((yyvsp[0].valor_lexico), (yyvsp[-2].data_type));
}
...
#line 436 "parser.y"
{
    ...
    (yyval.node) = create_node_token((yyvsp[0].ast_token), declared_exclamation);
}
...
#line 446 "parser.y"
{
    ...
    (yyval.node) = create_node_token((yyvsp[0].ast_token), declared_minus);
}
